...
const getAppliedRule = (dice) => {
  ...
  if (hasFive) return "Five of a Kind (50 points)";
  if (isLargeStraight) return "Large Straight (40 points)";
  if (isSmallStraight) return "Small Straight (20 points)";
  if (hasFour) return `Four of a Kind (Sum: ${sumOfDice})`;
